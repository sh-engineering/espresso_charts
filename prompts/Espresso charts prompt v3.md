...
Produce **1–2 charts** per story. Each chart should have one main takeaway.
...
**Story:** [Story title]
**Slide 1:** `DD_slug/assets/cover.png`
**Slide 2:** `DD_slug/assets/chart1_descriptor.png`
**Slide 3:** `DD_slug/assets/chart2_descriptor.png`
